## SVB Modified layout of this library to allow it to work with Platformio

This library is based on the [Seeed Studio PN532 library](https://github.com/Seeed-Studio/PN532).  
To get it to work under a Platformio project files have been moved into a single directory and `#include` directives have been changed to point to the new locations.
